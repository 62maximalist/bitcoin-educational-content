...
Fitur ini memungkinkan kamu menambahkan ketentuan pengeluaran ke perangkat Coldcard (Q atau Mk4) menggunakan cara seperti *Hardware Security Module* (HSM), untuk melindungi dana kamu sambil tetap memberikan fleksibilitas dan kontrol yang luas atasnya.
...
- Batas kecepatan:** tentukan berapa banyak transaksi yang dapat kamu lakukan per unit waktu (per jam, hari, minggu, dll.), yang membutuhkan jumlah minimum blok di antaranya.
...
Dengan menambahkan seed kedua ke perangkat Coldcard Mk4 atau Q kamu, yang disebut Spending Policy Key, dan akan kita sebut sebagai C Key sepanjang tutorial ini.

Selain seed tambahan ini, kamu juga perlu menyertakan setidaknya satu kunci tambahan (XPUB) yang akan kita sebut Kunci Cadangan, untuk membuat wallet multisig 2-of-N.

Singkatnya, kita akan membuat wallet multisig, dan perangkat Coldcard kamu akan menyimpan dua kunci privat yang dibutuhkan untuk membelanjakan dana: master seed perangkat dan Spending Policy Key.

Setiap kali C Key diminta untuk menandatangani, ketentuan pembelanjaan yang sudah ditentukan akan diterapkan, dan Coldcard hanya akan menandatangani jika transaksi sesuai dengan ketentuan tersebut.

Kalau kamu ingin mengabaikan ketentuan pengeluaran ini, kamu tetap bisa melakukannya:

- dengan menandatangani dengan salah satu kunci cadangan dan tangan seed, atau 2 kunci cadangan tergantung pada ukuran Multisig kamu.
...
Pada Mk4 atau ColdCardQ milikmu, buka *Alat Bantu Lanjutan > Penandatanganan Bersama ColdCard*.
...
- Atau tekan **"(6) "** untuk mengimpor seed dari brankas perangkat milikmu.

Untuk keperluan tutorial ini, kami memutuskan untuk mengimpor seed 12 kata yang sudah ada dengan menekan **"(1) "**. Ini bisa berupa seed BIP39 yang sudah kamu punya, dan tentunya kamu memiliki cadangannya.

Gunakan papan ketik Anda untuk memasukkan 12 kata dari seed kamu. Untuk contoh ini, kita akan memilih frasa valid seed daging sapi x 12. Kemudian tekan **"MEMASUKKAN "**.

*NB: jika Anda tidak memiliki cadangan seed ini, kamu tidak dapat lagi mengubah pengaturan "Co-Sign" pada perangkat milikmu, untuk mengubah kondisi pengeluaran milikmu*
...
Kemudian kamu dapat memilih nilai maksimum, yaitu jumlah maksimum satoshi yang dapat dibelanjakan dalam satu transaksi.
...
(Jika perangkat kedua milikmu adalah ColdCardQ, kamu akan memiliki opsi untuk mengekspor Xpub Anda melalui kode QR, tentu saja).
...
Dari menu utama ColdCardQ kamu, pilih **"Pengaturan "**, lalu **"Dompet Multisig"**.

Kumpulan dompet Multisig yang dikenal dengan ColdCard kamu sekarang ditampilkan, dengan jumlah kunci yang terlibat di sini "2/3" (2-sur3). Pilih Multisig **"ColdCard Co-Sign "** yang baru saja kita buat, lalu klik **"ColdCard Export "**.
...
Kemudian klik **"Impor File "**. Kemudian pilih file **"export-Coldcard_Co-sign.txt "** pada kartu SD kamu.

![Co-Sign](assets/fr/13.webp)

Berikan nama pada Wallet kamu seperti yang akan muncul pada Sparrow, dan pilih kata sandi untuk mengenkripsi Wallet milikmu (atau tidak).
...
Pindai kode QR yang terkait dengan alamat (kami akan memilih 2) yang ingin kamu tambahkan ke daftar putih, lalu klik **"MASUK "**. Setelah memvalidasi alamat kamu dengan menekan **"MASUK "** secara berurutan, kami melihat bahwa batasan Magnitude dan alamat penerima telah diterapkan.
...
Fitur ini memungkinkan kamu menggunakan aplikasi yang sesuai dengan TOTP RFC-6238 seperti Google Authenticator / Ente Auth / Proton Authenticator / Authy 2FA / atau Aegis Authenticator, untuk menambahkan keamanan Layer ekstra.
...
Secara konkretnya, sebelum menandatangani transaksi, kamu harus mendekatkan perangkat yang terhubung dengan NFC dan terhubung dengan internet ke Coldcard. Secara otomatis, kamu akan diarahkan ke halaman web coldcard.com, di mana kamu akan diminta untuk memasukkan kode 6 digit untuk aplikasi kamu. Kalau kamu memasukkan kode yang benar, halaman web akan menampilkan kode QR untuk memindai ColdCardQ, atau kode 8 digit untuk dimasukkan ke Mk4 kamu, untuk mengotorisasi perangkat kamu agar dapat ditandatangani.

![Co-Sign](assets/fr/33.webp)

Setelah memindai kode QR yang ditampilkan di aplikasi autentikasi ganda kamu, dan menambahkan akun ColdCard Co-Sign (CCC) milikmu, kamu akan diminta untuk memverifikasi bahwa semuanya sudah sesuai dengan memasukkan kode 2FA.

Ketik ColdCard kamu ke bagian belakang perangkat NFC.

![Co-Sign](assets/fr/34.webp)

Pada halaman web yang terbuka, masukkan kode 2FA aplikasi favorit kamu. Kemudian pindai kode QR yang ditampilkan dengan ColdCardQ milikmu (atau masukkan kode 8 digit yang ditampilkan di Mk4).
...
Setelah transaksi dibuat, klik pada 3 titik kecil di sudut kanan atas untuk mengekspornya ke ColdCard kamu.

![Co-Sign](assets/fr/44.webp)

Kemudian pilih **"Ekspor melalui BBQR "**, dan pindai kode QR yang ditampilkan dengan ColdCardQ kamu.

![Co-Sign](assets/fr/45.webp)

ColdcardQ kamu kemudian menampilkan peringatan yang, saat kamu scroll ke bagian bawah layar, menjelaskan bahwa transaksi tersebut melanggar ketentuan pembelanjaan, seperti yang diharapkan.
...
Kalau kamu masih memvalidasi dengan menekan **"ENTER "**, kode QR yang mewakili transaksi yang ditandatangani akan muncul. Kalau kamu mengimpornya di Nunchuk, Kamu bisa melihat bahwa hanya satu tanda tangan yang telah diterapkan.
...
Kemudian pindai kode QR yang muncul di halaman web, untuk mengesahkan ColdCard milikmu untuk menandatangani transaksi.

Transaksi sekarang ditandatangani oleh 2 kunci dan oleh karena itu valid.

Jika "Push Tx" diaktifkan pada ColdCardQ, kamu dapat menyiarkan transaksi secara langsung ke jaringan dengan mengetuk bagian belakang ponsel cerdas milikmu.

![Co-Sign](assets/fr/52.webp)

Kalau kamu tidak mengaktifkan "Push tx", tekan tombol "QR" pada ColdCardQ kamu untuk menampilkan transaksi yang telah ditandatangani sebagai kode QR, dan mengimpornya ke Nunchuk, dengan cara yang sama seperti pada contoh sebelumnya.
...
Kita sudah sampai di akhir tutorial ini, yang memberi kamu gambaran umum tentang berbagai kemungkinan yang ditawarkan oleh fitur Co-Sign yang terintegrasi dalam perangkat Coldcard Q dan Mk4 dari Coinkite, serta cara penggunaannya lewat wallet seperti Sparrow dan Nunchuk.
