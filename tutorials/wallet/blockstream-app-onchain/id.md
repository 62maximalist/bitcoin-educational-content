...
- **Fungsi**: Merutekan traffic jaringan melalui **Tor**, sebuah jaringan anonim yang mengenkripsi koneksi kamu.
- Mengapa? Menyembunyikan IP Address dan melindungi privasi kamu, ideal jika kamu tidak mempercayai jaringan kamu (Wi-Fi publik, misalnya).
...
**Penting**: Aplikasi Blockstream telah menyederhanakan pembuatan Wallet dengan tidak secara otomatis menampilkan frasa seed yang terdiri dari 12 kata. *Meskipun portofolio sekarang dibuat dalam satu klik, kamu berisiko kehilangan akses ke uang milikmu jika tidak menyimpan seedphrasemu*.
...
12 kata seedphrase akan ditampilkan untuk kamu simpan.

- Tuliskan frasa pemulihan kamu dengan sangat hati-hati. Tuliskan di atas kertas atau logam dan simpan di tempat yang aman (lokasi yang aman dan offline). Frasa ini adalah satu-satunya cara untuk mengakses bitcoin kamu jika perangkat hilang atau aplikasi dihapus.
- Penting juga untuk diperhatikan bahwa siapa pun yang memiliki frasa ini dapat mencuri semua bitcoin kamu. Jangan pernah menyimpannya secara digital:
...
Sebelum mengirim dana ke Address yang terkait dengan kalimat seed ini, kamu harus menguji cadangan 12 kata milikmu.
...
- Hapus aplikasi, lalu pulihkan Wallet melalui **"Pulihkan dari Cadangan "** dengan memasukkan frasa Mnemonic, dan periksa apakah zpub tidak berubah. Jika ya, maka cadangan kamu sudah benar, dan dapat mengirim dana ke Wallet.
...
- **Lindungi privasi kamu** :
 ...
 - Untuk kerahasiaan maksimum, sambungkan Wallet kamu ke node Bitcoin kamu sendiri melalui server Electrum alih-alih menggunakan node publik

- **Pilih jaringan yang paling sesuai dengan kebutuhan**:
