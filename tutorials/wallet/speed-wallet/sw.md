...
- Hifadhi na Exchange bitcoins zako.





- Nunua huduma za kidijitali kupitia ujumuishaji wa Bitrefill.





- Kubali Bitcoin katika biashara yako kupitia programu ya kuuza.
...
Katika somo hili, tutaangazia jukwaa la programu ya Android, lakini michakato yote ambayo itawasilishwa katika mafunzo haya ni halali kwa usawa kwenye iOS.
...
Kutoka kwa Mipangilio, unaweza pia kubinafsisha jinsi salio lako linavyoonyeshwa kwa kuchagua sarafu ya eneo lako katika chaguo
...
Kwenye ukurasa wa nyumbani wa **Wallet**, utapata :





- Sehemu ya sarafu ambayo ungependa kutumia.





- Salio lako katika sarafu uliyochagua.
...
Bofya kitufe cha **Pokea**, kisha uchague Layer ambayo ungependa kupokea na kiasi cha muamala ili kushiriki Invoice yako na mtumaji wako.



Unaweza pia kutumia Lightning Address yako unapotaka kumpa mtumaji wako wepesi wa kufafanua kiasi cha muamala.
...
Kutoka kwa kitufe cha **Tuma**, unaweza kutuma bitcoins kwa kutumia Lightning Address, Lightning Invoice au Bitcoin (Mainnet) Address ya mpokeaji.
...
Katika menyu ya **Programu**, unaweza kupata majukwaa mengi, michezo, ofa za punguzo, huduma lakini pia mifumo ya kupata bitcoins kwa kutekeleza majukumu.
...
Katika sehemu ndogo ya **Ofa**, fahamu kuhusu punguzo la kwanza la amana zinazotolewa na mifumo ya michezo ya kubahatisha.
...
Katika sehemu ya **Pata**, utapata mifumo unayoweza kutumia kupata satoshi kwa kutekeleza majukumu.
...
Katika menyu ya **Duka**, utapata Bitrefill, ambayo hukuleta karibu zaidi na huduma za kidijitali (kadi za zawadi, nyongeza za simu, n.k.) zinazopatikana katika eneo lako na popote pengine.



Tazama somo letu la jinsi ya kuanza kutumia Bitrefill hapa chini.
...
Ili kuhitimu, lazima ukidhi vigezo vifuatavyo:





- Mpango wa ufadhili unapatikana katika nchi yako.





- Akaunti yako ina umri wa angalau Saa 24.





- Una angalau **Satoshi 1000 au USDT 1** kwenye kwingineko yako.





- Mwaliko na zawadi si tu kwa akaunti yako.
...
Katika chaguo la **Mipangilio** kwenye ukurasa wa **Wallet**, sehemu ya **Programu Ndogo** hukuruhusu kubinafsisha na kudhibiti programu zote ambazo umeongeza.
...
Fungua kiendelezi kwenye kivinjari chako, kisha ingia.
...
Thibitisha kompyuta yako ili kuidhinisha ufikiaji wa kwingineko yako.
...
Kutoka [Biashara ya Kasi](https://www.tryspeed.com/), una kijumlishi cha malipo kilichounganishwa ili kukubali Bitcoin, inayoendeshwa na Lightning Network ambayo unaweza kutumia dukani kwako, mtandaoni au kimwili.



Kwa kulenga malipo, utapata chaguzi zifuatazo:
