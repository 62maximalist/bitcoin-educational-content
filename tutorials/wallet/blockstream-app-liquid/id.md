...
**Catatan:** Tutorial ini berfokus pada cara menggunakan Liquid lewat Aplikasi Blockstream. Kalau kamu mau memahami lebih dalam tentang Liquid Network, kamu bisa lihat sumber daya yang ada di lampiran.
...
- Mengapa? Menyembunyikan IP Address dan melindungi privasi kamu, ideal jika kamu tidak mempercayai jaringan (Wi-Fi publik, misalnya).
...
- **Fungsi**: Menghubungkan aplikasi ke **node Bitcoin lengkap** milik kamu sendiri melalui **server Elektrum**.
...
- **Rekomendasi**: Aktifkan SPV jika kamu tidak dapat menggunakan simpul pribadi, tetapi lebih memilih Full node untuk keamanan optimal.
...
- Kalau kamu ingin mengelola **Cold Wallet** (Wallet offline): klik **"Hubungkan Jade "** untuk menggunakan Hardware Wallet Blockstream Jade atau dompet Cold lainnya yang kompatibel.
...
- (3) **"Hanya-Baca "**: Mengimpor portofolio hanya-baca yang sudah ada, untuk melihat saldo (mis. dari Cold Wallet kamu) tanpa mengekspos frasa Mnemonic. Lihat tutorial "Watch Only" di lampiran.

**Dalam tutorial ini**: Klik **"Setup Mobile Wallet"** untuk membuat Hot Wallet.

Wallet milikmu secara otomatis dibuat dan halaman beranda Wallet, di sini disebut "My Wallet 5", ditampilkan:

![image](assets/fr/07.webp)

**Penting**: Aplikasi Blockstream telah menyederhanakan pembuatan Wallet dengan tidak secara otomatis menampilkan frasa seed yang terdiri dari 12 kata. *Meskipun portofolio sekarang dibuat dalam satu klik, kamu berisiko kehilangan akses ke uangmu jika kamu tidak menyimpan seedphrase kamu*.
...
Frasa 12 kata seed akan ditampilkan untuk kamu simpan.

- Tulis seedphrase kamu dengan sangat hati-hati. Gunakan kertas atau logam, lalu simpan di tempat yang aman dan offline. Seedphrase ini adalah satu-satunya cara kamu bisa mengakses bitcoin kalau perangkatmu hilang atau aplikasinya terhapus.
- Penting banget diingat: siapa pun yang punya seedphrase kamu bisa mencuri semua bitcoin milikmu. Jangan pernah menyimpannya secara digital.
...
Sebelum mengirim dana ke Address yang terkait dengan frasa seed ini, kamu harus menguji cadangan 12 kata milikmu.
...
- Hapus aplikasi, lalu pulihkan Wallet melalui **"Pulihkan dari Cadangan "** dengan memasukkan frasa Mnemonic, dan periksa apakah zpub tidak berubah. Jika ya, maka cadangan milikmu sudah benar, dan kamu bisa mengirim dana ke Wallet.
...
Atau, Exchange bitcoin kamu di blockchain atau melalui Lightning Network untuk L-BTC menggunakan [jembatan seperti Boltz] (https://boltz.Exchange/): masukkan Liquid kamu yang menerima Address, lakukan pembayaran sesuai keinginan, dan terima L-BTC kamu.
...
- **Opsi** :
 - (1) Klik tanda panah untuk memilih Address baru lainnya yang terkait dengan kalimat seed ini.
    - (2) Kamu juga dapat memilih Address dari antara yang sudah digunakan/ditampilkan, dengan mengeklik tiga titik di kanan atas dan kemudian pada "Daftar Alamat"
...
Untuk menggunakan **Aplikasi Blockstream** dengan aman dan efisien, ikuti rekomendasi berikut ini. Rekomendasi ini akan membantu kamu melindungi dana, mengoptimalkan transaksi, dan menjaga kerahasiaan kamu di jaringan **Bitcoin (onchain)**, **Liquid**, dan **Lightning**.

- **Amankan frasa pemulihan milikmu** :
...
- **Pilih jaringan yang paling sesuai dengan kebutuhanmu**:
